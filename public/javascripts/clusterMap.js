...
const map = new mapboxgl.Map({
    container: 'cluster-map',  // the id on the div where the map is supposed to be. Also tied to any pertinent css files.
...
map.on('load', () => {
    ...
    map.addLayer({
        ...
        paint: {
            ...
            //   * Yellow, 30px circles when point count is between 20 and 75
